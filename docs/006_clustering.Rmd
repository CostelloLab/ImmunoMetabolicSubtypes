...
names(enriched_conditions)[2] <- "Neighbors"

p1 <- ggplot(enriched_conditions, aes(x = clusters, y = value, color = Neighbors)) +
    geom_line(size = 2.5) +
    theme_classic() +
    ylab("# of enriched features") + xlab("# of clusters") 
    
pdf("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/neighbors/num_neighbors_2024_01_12.pdf", height = 4, width = 10)
print(p1)
dev.off()
