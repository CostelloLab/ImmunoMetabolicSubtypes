...
all_clust <- nemo.clustering(omics.list = list(t(T21.mixed$cytokines),t(T21.mixed$metabolites)),num.clusters = 4,num.neighbors = 43)
...
cyt_clust <- nemo.clustering(omics.list = list(t(T21.mixed$cytokines)),num.clusters = 2,num.neighbors = 43)
...
met_clust <- nemo.clustering(omics.list = list(t(T21.mixed$metabolites)),num.clusters = 3,num.neighbors = 43)
