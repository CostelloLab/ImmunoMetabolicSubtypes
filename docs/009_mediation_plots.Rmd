...
```r
cluster_enrichment <-  clusterPathwayEnrichment(gsea_results)

cluster_enrichment_toplot <- lapply(cluster_enrichment, function(x) x %>% dplyr::select(pathway, combined_p))
...
pdf("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/mediation_heatmaps/global_pathway_heatmaps/cluster_mediation_pathway_enrichment_combined_p_2024_04_12.pdf")
print(p1)
dev.off()
