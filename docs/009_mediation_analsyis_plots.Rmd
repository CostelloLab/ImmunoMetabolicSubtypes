...
knitr::opts_chunk$set(echo = FALSE, root.dir = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/")
```
...
library(tidyverse)
load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/full_z_percent_8_31.RData")
...
library(tidyverse)
library(ggplot2)
load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/long_z_12_4.RData")
```
...
```{r  data}
library(tidyverse)
load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/partial_corrlation_gsea_results_formatted_12_4.RData")
...
```{r ordered global heatmap }
load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/full_partial_correlation_results_11_27.RData")

T21_cyt_met <- full_results %>%
    filter(cluster == "T21") %>%
    filter(cor_cyt_met_p < .05) %>%
    distinct(cyt_met)

T21_filtered_full_results <- full_results %>%
    filter(cyt_met %in% T21_cyt_met$cyt_met)
...
met_path$pathway[is.na(met_path$pathway)] <- "unknown"
...
multiHeatmapOrderedGSEA(toplot1 = toplot1, 
                        ...
                        met_path = met_path,
                        formatted_gsea = gsea_results_formatted[[1]] ,
                        full_results = T21_filtered_full_results,
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/2D_filtered_ordered-IFN-gamma.pdf",
...
multiHeatmapOrderedGSEA(toplot1 = toplot1,
                        ...
                        formatted_gsea = gsea_results_formatted[[1]] ,
                        full_results = T21_filtered_full_results,
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/2D_filtered_ordered-HEME-METABOLISM.pdf",
...
multiHeatmapOrderedGSEA(toplot1 = toplot1,
                        ...
                        formatted_gsea = gsea_results_formatted[[1]] ,
                        full_results = T21_filtered_full_results,
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/2D_filtered_ordered-OXIDATIVE-PHOSPHORYLATION.pdf",
...
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, name = "Interferon Gamma Response", output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/cluster_heatmaps_IFN-gamma-Response-ranks.pdf")
...
cluster_ranks <- clusterGeneRanks(cyt_mets = cyt_mets,
                                  ...
                                  gene_sets = pathways_all)
names(cluster_ranks) <- names(long_z)
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, name = "Heme Metabolism", output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/cluster_heatmaps_Heme-Metabolism-ranks.pdf")
...
cluster_ranks <- clusterGeneRanks(cyt_mets = cyt_mets,
                                  ...
                                  gene_sets = pathways_all)
names(cluster_ranks) <- names(long_z)
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, name = "Oxidative Phosphorylation", output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/cluster_heatmaps_Oxidative_phosphorylation-ranks.pdf")



```

### Heatmap of gsea scores
...
DSPathwayHeatmap <- function(input, title, tolabel = "", DS_pathways) {
  ...
  # pdf( "T21_pathway_heatmap.pdf")
   pdf(paste0("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/",title,"_DS_pathways_heatmap.pdf"), width = 12, height = 4)
...
### Exploring some of the top results for reporting out in the paper

```{r}
### The full results file was loaded in an earlier chunk. If only running this chunk, then you will need to load this again
##load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/full_partial_correlation_results_11_27.RData")

### Exploring relationships in key cyt_mets and genes
key_cyt_met <- "IFN-gamma-acyl-C14 (O-tetradecanoyl-L-carnitine)"
key_cyt_met <- "VEGF-A-L-Methionine S-oxide"
key_cyt_met <- "MCP-1-Creatinine"
key_cyt_met <- "IFN-gamma-acyl-C14 (O-tetradecanoyl-L-carnitine)"
key_cyt_met <- "IL-12p70-Indole"
key_cyt_met <- "IL-22-Choline"
key_cyt_met <- "IL-22-acyl-C5"
key_gene <- "HIF1A"



full_results %>%
    filter(cyt_met == key_cyt_met & gene == key_gene) %>%
    filter(cluster == "T21")



tmp_full <- full_results %>%
    filter(cyt_met == key_cyt_met) %>%
    filter(cluster == "T21") %>%
    arrange(-percent_diff)

tmp_full <- head(tmp_full)
tmp_full$padj <- p.adjust(tmp_full$cor_cyt_met_p)


### Finding ranks of specific gene in a cytokine-metabolite relationship
...
### Find specific GSEA Results

```{r}

load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/partial_cor_gsea_results_12_4.RData")
gsea_results <- lapply(gsea_results, function(x) x[-155]) ## Removed due to NA values
load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/partial_corrlation_gsea_results_formatted_12_4.RData")

source("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/R/partial_correlation_functions.R")
tmp_gsea_results = gsea_results
tmp_gsea_results_formatted = gsea_results_formatted[[1]]
key_pathway = "HALLMARK_HEME_METABOLISM"
cyt_met_example = "VEGF-A-L-Methionine S-oxide"
tmp_res <- gseaFinder(key_pathway = "HALLMARK_HEME_METABOLISM", cyt_met_example = "VEGF-A-L-Methionine S-oxide", tmp_gsea_results = tmp_gsea_results, tmp_gsea_results_formatted = tmp_gsea_results_formatted)


tmp_lead <- tmp_res$leadingEdge[[1]]
tmp_full$gene[1:10]


```

### Cytokine-metabolite mediation signatures
```{r}
tmp_gsea_results = gsea_results[[1]]
tmp_gsea_results_formatted = gsea_results_formatted[[1]]
tmp_toplot_clusters = toplot_clusters[[1]]

pathways <- names(pathways_all)

source("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/R/partial_correlation_functions.R")
mediation_signatures <- lapply(pathways, function(x) mediationSignatures(key_pathway = x,tmp_gsea = tmp_gsea_results, tmp_toplot_clusters = tmp_toplot_clusters))
...
### Finding the cyt-mets that are distinct in one cluster vs all others
...
load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/partial_corrlation_gsea_results_formatted_12_4.RData")
scores <- names(gsea_results_formatted[[1]])
gsea_results_formatted <- lapply(gsea_results_formatted, setNames, scores)

load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/long_z_12_4.RData")


names(long_z) <-as.character(c("T21","D21",1,2,3,4,5))
pathways_all <- gmtPathways("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/data/pathway/h.all.v2023.1.Hs.symbols.gmt")
cyt_mets <- unique(long_z[[1]]$cyt_met)

tmp_key_pathway = "HALLMARK_HEME_METABOLSIM"

sig_list <- mediation_signatures[[tmp_key_pathway]]

cluster_5_ifn_cyt_mets <- filterCyt_Mets_unbiased(gene_sets = pathways_all,
                        key_pathway = tmp_key_pathway,
                        formatted_gsea = gsea_results_formatted[[7]],
                        sig_list = sig_list,
                        key_cluster = "5",
                        all_results = full_results)
ifn_cluster_ranks <- clusterGeneRanks(cyt_mets = cluster_5_ifn_cyt_mets,
                                  gene_sets = pathways_all,
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks, name = "Heme Metabolism Cluster 5", output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/cluster_5_heatmaps_Heme_metabolism-ranks.pdf")


cluster_2_ifn_cyt_mets <- filterCyt_Mets_unbiased(gene_sets = pathways_all,
                        key_pathway = tmp_key_pathway,
                        formatted_gsea = gsea_results_formatted[[4]],
                        sig_list = sig_list,
                        key_cluster ="2",
                        all_results = full_results)

ifn_cluster_ranks_2 <- clusterGeneRanks(cyt_mets = cluster_2_ifn_cyt_mets,
                                  gene_sets = pathways_all,
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks_2, name = "Heme Metabolism Cluster 2", output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/cluster_2_heatmaps_Heme_metabolism-ranks.pdf")

cluster_3_ifn_cyt_mets <- filterCyt_Mets_unbiased(gene_sets = pathways_all,
                        key_pathway = tmp_key_pathway,
                        num_cyt_met = 10,
                        formatted_gsea = gsea_results_formatted[[5]],
                        sig_list = sig_list,
                        key_cluster = "3",
                        all_results = full_results)
ifn_cluster_ranks_3 <- clusterGeneRanks(cyt_mets = cluster_3_ifn_cyt_mets,
                                  gene_sets = pathways_all,
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks_3, name = "Heme Metabolism Cluster 3", output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/cluster_3_heatmaps_Heme_metabolism-ranks.pdf")
cluster_4_ifn_cyt_mets <- filterCyt_Mets_unbiased(gene_sets = pathways_all,
                        key_pathway = tmp_key_pathway,
                        num_cyt_met = 10,
                        formatted_gsea = gsea_results_formatted[[6]],
                        sig_list= sig_list,
                        key_cluster="4",
                        all_results = full_results)
ifn_cluster_ranks_4 <- clusterGeneRanks(cyt_mets = cluster_4_ifn_cyt_mets,
                                  gene_sets = pathways_all,
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks_4, name = "Heme Metabolism Cluster 4", output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/cluster_4_heatmaps_Heme_metabolism-ranks.pdf")
cluster_1_ifn_cyt_mets <- filterCyt_Mets_unbiased(gene_sets = pathways_all,
                        key_pathway = tmp_key_pathway,
                        num_cyt_met = 10,
                        formatted_gsea = gsea_results_formatted[[3]],
                        sig_list= sig_list,
                       key_cluster = "1",
                        all_results = full_results)
ifn_cluster_ranks_1 <- clusterGeneRanks(cyt_mets = cluster_1_ifn_cyt_mets,
                                  gene_sets = pathways_all,
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks_1, name = "Heme Metabolism Cluster 1", output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/cluster_1_heatmaps_Heme_metabolism-ranks.pdf")



library(ggvenn)
x <- list("cluster 5" = rownames(ifn_cluster_ranks[[1]]),
          "cluster 2" = rownames(ifn_cluster_ranks_2[[1]]),
          "cluster 4" = rownames(ifn_cluster_ranks_4[[1]]),
          "cluster 3" = rownames(ifn_cluster_ranks_3[[1]]))
...
## Comparing the correlations between T21 and D21 individuals
``` r

library(ggrepel)

T21vD21 <- full_results %>%
    filter(cluster %in% c("T21", "D21")) %>%
    dplyr::select(cyt_met, cor_cyt_met_r, cor_cyt_met_p, cluster) %>%
    distinct(cyt_met, cor_cyt_met_r, cor_cyt_met_p, cluster)
...
T21vD21 <- T21vD21 %>%
    mutate(D21_p_adj =  p.adjust(cor_cyt_met_p_D21, method = "fdr")) %>%
    mutate(T21_p_adj =  p.adjust(cor_cyt_met_p_T21, method = "fdr")) %>%
    mutate(flag = (T21_p_adj < .05 | D21_p_adj < .05))  %>%
    mutate(label = ifelse( (T21_p_adj < .005 | D21_p_adj < .005)  , cyt_met, ""))


p1 <- ggplot(T21vD21, aes(x = cor_cyt_met_r_D21, y = cor_cyt_met_r_T21, color = flag, label = label)) +
    geom_point() +
    scale_color_manual( values = c( "gray", "black"))+
    geom_label_repel(max.overlaps = 1e3,size = 2,box.padding = 1.5) +
    theme_classic() +
    xlab("D21 correlation coefficient") +
    ylab("T21 correlation coefficient") +
    theme(legend.position = "none") +
...
pdf(file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/T21_D21_correlation_scatter.pdf", height = 8, width = )
print(p1)
dev.off()
...
``` r
load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/differential_expression/differential_expression_results_2023-09-08.RData")

load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/differential_expression/gsea_results_diff_2023-09_08.Rdata")

lapply(gsea_results_diff, function(x) {
    x %>% arrange(padj) %>% head()})
```
...
trendPlot <- function(input, pathway, title ="", to_label) {
  ...
  if(pathway %in% rownames(input))  {
    ...
    p1 <-  ggplot(tmp_toplot, aes_string(x = "rank", y = pathway, label = "label")) +
     ...
     pdf(paste0("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/",title, "_", pathway, "trend.pdf"), height = 6, width = 10)
    print(p1)
    dev.off()
...
trendPlotclusters <- function(input_list, pathway, title ="", sd_thresh = 2.5) {
   ...
   melted_toplot_clusters$label <- ifelse(abs(melted_toplot_clusters$value) > (sd_thresh * sd(melted_toplot_clusters$value, na.rm = T)) , melted_toplot_clusters$cyt_met, "")   
    ...
    p1 <- ggplot(melted_toplot_clusters, aes_string(x = "rank", y = "value", color = "cluster", label = "label")) +
      ...
      xlab("Cytokine - Metabolite Associations") +
      ylab("NES")
   pdf(paste0("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/",title, "_", pathway, "trend_all_clusters.pdf"), height = 6, width = 10)
     print(p1)
    dev.off()
...
leadingEdgeDensity <- function(cyt_met_example, key_pathways) {
  ...
  ggsave(plot = p1, 
         filename = paste0("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/",cluster, "_", cyt_met_example,"_", key_pathways[1], "_", key_pathways[2],"_", "leading_edge_density.pdf"),
...
write.csv(res, file = paste0("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/gene_annotation/", cluster, "_", key_pathway, "_", cyt_met_example, ".csv"))
```
...
diff_expr_toplot <- gsea_results_diff_formatted %>%
 ...
 DS_pathways <- c("HALLMARK_INTERFERON_GAMMA_RESPONSE", 
  ...
  # pdf( "T21_pathway_heatmap.pdf")
pdf(file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/differential_expression_DS_pathways_heatmap.pdf", width = 2.5, height = 12)
draw(p1,heatmap_legend_side="bottom")
dev.off()
...
qqplot <- function(pathway, cluster1,cluster2) {
  ...
  ggsave(plot = p1, 
         filename = paste0("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/qqplot", "_", pathway,"_", cluster1, "_", cluster2,".pdf"),
          device = "pdf", height = 6, width = 10)
...
key_pathway <- "HALLMARK_INTERFERON_GAMMA_RESPONSE"
chr21_genes <- read_tsv( file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/data/protein-coding_gene_chr_21.txt")
...
# full_plot = grid.arrange(grobs = list(p2,p1,p3),  layout_matrix = rbind(c(1,NA), c(2,3)), widths = c(10,2), heights = c(2,10))
  ...
  ggsave(plot = full_plot, 
         filename = paste0("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/z_score_qqplot", "_",cyt_met_example,"_", key_pathway,"_", cluster1, "_", cluster2,".pdf"),
...
ClusterPathwayHeatmap <- function(input, cyt_met_example,  key_pathways) {
  ...
  # pdf( "T21_pathway_heatmap.pdf")
   pdf(paste0("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/",cyt_met_example, "_", "_cluster_heatmap.pdf"), width = 10, height = 4)
  draw(p1,heatmap_legend_side="bottom")
  dev.off()
} 
...
T21_corr = read.xlsx("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/tables/cluster_correlations_D21.xlsx")
T21_corr <- T21_corr %>%
...
#    filter(cluster %in% c("T21", key_cluster)) %>%
 ...
 g <- marrangeGrob(plots, nrow = 6, ncol = 1)
  ...
  ggsave(filename = paste0("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/figures/T21_vs_cluster_mediation_signatures.pdf"), g,height = 25,width = 25, units = "in") 
