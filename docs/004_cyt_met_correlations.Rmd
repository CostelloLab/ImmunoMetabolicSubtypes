...
all_correlations$diff <- all_correlations$r.x - all_correlations$r.y

all_correlations <- all_correlations %>%
    arrange(-abs(diff))

sig_correlations <- all_correlations %>%
    filter(fdr.x < .2 & fdr.y < .2)

ggplot(sig_correlations, aes(x = r.x, y = r.y)) +
    geom_
