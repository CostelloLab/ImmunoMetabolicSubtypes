...
diff_expr <- get(load("~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/differential_expression/gsea_results_diff_2023-09_08.RData"))
...
names(long_z) <- c("T21", "D21", 1,2,3,4,5)
```
...
DS_pathways <- DS_pathways[c(1,3,5,8)]

toplot1 <- heatmapDataPrep(key_pathways = DS_pathways,
...
multiHeatmap(toplot1 = toplot1,
             ...
             output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/2D.pdf")
```
## Heatmaps ordered by gene set enrichment
...
multiHeatmapOrderedGSEA(toplot1 = toplot1, 
                        ...
                        formatted_gsea = gsea_results_formatted[[1]] ,
                        full_results = full_results,
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/2D_ordered-IFN-gamma.pdf",
...
multiHeatmapOrderedGSEA(toplot1 = toplot1,
                        ...
                        formatted_gsea = gsea_results_formatted[[1]] ,
                        full_results = full_results,
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/2D_ordered-HEME-METABOLISM.pdf",
...
multiHeatmapOrderedGSEA(toplot1 = toplot1,
                        ...
                        formatted_gsea = gsea_results_formatted[[1]] ,
                        full_results = full_results,
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/2D_ordered-OXIDATIVE-PHOSPHORYLATION.pdf",
...
multiHeatmapOrderedGSEA(toplot1 = toplot1,
                        ...
                        formatted_gsea = gsea_results_formatted[[1]] ,
                        full_results = full_results,
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/2D_ordered-E2F-TARGETS.pdf",
...
source("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/R/partial_correlation_functions.R")
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_heatmaps_IFN-gamma-Response-ranks.pdf")
...
cluster_ranks <- clusterGeneRanks(cyt_mets = cyt_mets,
                                  ...
                                  gene_sets = pathways_all)
names(cluster_ranks) <- names(long_z)
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_heatmaps_Heme-Metabolism-ranks.pdf")
