...
library(tidyverse)
library(ggplot2)
load("~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/_1_long_z_11_27.RData")
```
...
key_cyt_met <- "MIP-1beta-Icosatetraenoic acid"
key_gene <- "STAT1"
