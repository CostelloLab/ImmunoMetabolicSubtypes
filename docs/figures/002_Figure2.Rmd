...
pdf(paste0("~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/",key_cyt_met,"_Z_trend_plot.pdf"), width = 10, height = 8)
print(p1)
dev.off()
...
pdf(paste0("~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/",key_gene,"_Z_trend_plot.pdf"), width = 10, height = 8)
print(p1)
dev.off()
```
...
load("~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/full_partial_correlation_results_11_27.RData")
...
multiHeatmapOrderedGSEA(toplot1 = toplot1, 
                        ...
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/2D_filtered_ordered-IFN-gamma.pdf",
...
multiHeatmapOrderedGSEA(toplot1 = toplot1,
                        ...
                        formatted_gsea = gsea_results_formatted[[1]] ,
                        full_results = T21_filtered_full_results,
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/2D_filtered_ordered-HEME-METABOLISM.pdf",
...
multiHeatmapOrderedGSEA(toplot1 = toplot1,
                        ...
                        formatted_gsea = gsea_results_formatted[[1]] ,
                        full_results = T21_filtered_full_results,
                        output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/2D_filtered_ordered-OXIDATIVE-PHOSPHORYLATION.pdf",
...
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, name = "Interferon Gamma Response", output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_heatmaps_IFN-gamma-Response-ranks.pdf")
...
cluster_ranks <- clusterGeneRanks(cyt_mets = cyt_mets,
                                  ...
                                  gene_sets = pathways_all)
names(cluster_ranks) <- names(long_z)
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, name = "Heme Metabolism", output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_heatmaps_Heme-Metabolism-ranks.pdf")
...
cluster_ranks <- clusterGeneRanks(cyt_mets = cyt_mets,
                                  ...
                                  gene_sets = pathways_all)
names(cluster_ranks) <- names(long_z)
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, name = "Oxidative Phosphorylation", output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_heatmaps_Oxidative_phosphorylation-ranks.pdf")
...
load("~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/partial_cor_gsea_results_12_4.RData")
gsea_results <- lapply(gsea_results, function(x) x[-155]) ## Removed due to NA values
load("~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/partial_corrlation_gsea_results_formatted_12_4.RData")
...
load("~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/long_z_12_4.RData")
...
ifn_cluster_ranks <- clusterGeneRanks(cyt_mets = cluster_5_ifn_cyt_mets,
                                  ...
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks, name = "Heme Metabolism Cluster 5", output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_5_heatmaps_Heme_metabolism-ranks.pdf")
...
ifn_cluster_ranks_2 <- clusterGeneRanks(cyt_mets = cluster_2_ifn_cyt_mets,
                                  ...
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks_2, name = "Heme Metabolism Cluster 2", output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_2_heatmaps_Heme_metabolism-ranks.pdf")
...
ifn_cluster_ranks_3 <- clusterGeneRanks(cyt_mets = cluster_3_ifn_cyt_mets,
                                  ...
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks_3, name = "Heme Metabolism Cluster 3", output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_3_heatmaps_Heme_metabolism-ranks.pdf")
...
ifn_cluster_ranks_4 <- clusterGeneRanks(cyt_mets = cluster_4_ifn_cyt_mets,
                                  ...
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks_4, name = "Heme Metabolism Cluster 4", output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_4_heatmaps_Heme_metabolism-ranks.pdf")
...
ifn_cluster_ranks_1 <- clusterGeneRanks(cyt_mets = cluster_1_ifn_cyt_mets,
                                  ...
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_HEME_METABOLISM")
clusterHeatmapWrapper(ifn_cluster_ranks_1, name = "Heme Metabolism Cluster 1", output_file = "~/OneDrive - The University of Colorado Denver/Projects/subPhenoDS/results/partial_correlation_results/figures/cluster_1_heatmaps_Heme_metabolism-ranks.pdf")
