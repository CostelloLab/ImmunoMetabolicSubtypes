...
```{r  data}
library(tidyverse)
load("~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/partial_correlation_results/partial_corrlation_gsea_results_formatted_.RData")
...
names(cluster_ranks) <- names(long_z)
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, name = "Heme Metabolism",all_correlations, output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/mediation_heatmaps/cluster_heatmaps/Heme_diff_filtered.pdf")
...
cluster_ranks <- clusterGeneRanks(cyt_mets = diff_cyt_metscyt_mets,
                                  long_z_list = long_z,
                                  key_pathway = "HALLMARK_OXIDATIVE_PHOSPHORYLATION",
                                  gene_sets = pathways_all)

names(cluster_ranks) <- names(long_z)
cluster_heatmaps <- clusterHeatmapWrapper(cluster_ranks, name = "Oxidative Phosphorylation",all_correlations, output_file = "~/OneDrive - The University of Colorado Denver/Projects/ImmunoMetabolicSubtypes/results/mediation_heatmaps/cluster_heatmaps/ox-phos_filtered.pdf")
